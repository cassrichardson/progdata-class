...
ggplot(plastic_waste_filtered) + 
  ...
  geom_smooth ()
```
# In these scatterplots, I compared the relationship between plastic waste per capita and total population or coastal population using a curved loess trend line. In the relationship with total population, waste increases as population increases, except for two outliers in countries with the highest populations that have low plastic waste. With coastal populations, plastic waste per capita actually tends to decrease with larger coastal populations.  
