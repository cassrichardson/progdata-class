...
---
# Step 1: Import the data for this lab:
...
## Answer: Families (id = x, x) are missing wave 2 data. It's easier to find this missing data in the longer format because each 